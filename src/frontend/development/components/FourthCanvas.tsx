...
export const FourthCanvas: FunctionalComponent<FourthCanvasProps> = (props: FourthCanvasProps) => {
	const { clientContext, dispatchClientEvent, setClientState } = useClientContext();
	...
	useEffect(() => {
		...
		function draw(e: MouseEvent) {
			...
			const x = e.offsetX / canvas!.width;
			const y = e.offsetY / canvas!.height;
			const drawOp = [DrawAction.ContinueStroke, x, y];
			internal.setClientState({
				...internal.clientContext.clientState,
				draw: [...internal.clientContext.clientState.draw, drawOp],
			});
		...
		function redrawCanvas() {
			...
			const drawOps = internal.clientContext.clientState.draw;
